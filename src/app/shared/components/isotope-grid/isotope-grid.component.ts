import { Component, OnInit, Input, ElementRef, AfterViewInit, AfterViewChecked, Renderer2, OnDestroy } from '@angular/core';
...
export class IsotopeGridComponent implements OnInit, AfterViewInit, AfterViewChecked, OnDestroy {
